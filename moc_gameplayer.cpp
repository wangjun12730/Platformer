...
QT_MOC_LITERAL(1, 11, 12), // "gradeChanged"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 11), // "nameChanged"
QT_MOC_LITERAL(4, 37, 4), // "name"
QT_MOC_LITERAL(5, 42, 5) // "grade"

    },
    "gamePlayer\0gradeChanged\0\0nameChanged\0"
    "name\0grade"
};
...
void gamePlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (gamePlayer::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&gamePlayer::gradeChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (gamePlayer::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&gamePlayer::nameChanged)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject gamePlayer::staticMetaObject = { {
    ...
    qt_meta_stringdata_gamePlayer.data,
    qt_meta_data_gamePlayer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void gamePlayer::gradeChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void gamePlayer::nameChanged()
{
